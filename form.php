...
<?php include "app/connection.php" ?>
    ...
    <form class="form-group" method="post" action="app/connection.php">
        ...
        <br>
        <input type="image" class="playButton" name="submit" src="images/images2/submit.png" value="submit" alt="Submit Button" style="border-style: none; height: auto; width: 18em;">
        <br>
