...
<?php include "app/connection.php" ?>
    ...
    <input type="image" class="playButton" name="update" src="images/images2/update.jpg" value="update" alt="Update Button" style="border-style: none; height: auto; width: 18em;">
    <br>
